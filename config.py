...
class Config(object):
    ...
    # RPN_ANCHOR_RATIOS_3D = [[0.5, 1, 2, 0.5, 1, 2],
    #                         [1, 1, 0.5, 2, 2, 1]]
    ...
    DETECTION_MIN_CONFIDENCE = 0.75 #0.9 0.75

    # Non-maximum suppression threshold for detection
    DETECTION_NMS_THRESHOLD = 0.3
    # DETECTION_NMS_THRESHOLD = 0.12
    ...
    def __init__(self):
        ...
        self.IMAGE_SHAPE = np.array(
            [self.IMAGE_HEIGHT, self.IMAGE_WIDTH, self.IMAGE_CHANNEL, 1])

        # Compute backbone size from input image size
        self.BACKBONE_SHAPES = np.array(
            [[int(math.ceil(self.IMAGE_SHAPE[0] / stride)),
              int(math.ceil(self.IMAGE_SHAPE[1] / stride)),
              # int(math.ceil(self.IMAGE_SHAPE[2] / stride*2))]
              int(math.ceil(self.IMAGE_SHAPE[2]))]
